...
from framework.test.piglit_test import PiglitCLTest, CLProgramTest
...
profile = XMLProfile('tests/cl.profile.xml')
...
def make_testlist():
    ...
    # Custom
    with tests.group_manager(PiglitCLTest, 'custom') as g:
    ...
    with tests.group_manager(PiglitCLTest, 'api') as g:
        # Platform
    ...
    with tests.group_manager(PiglitCLTest, 'program') as g:
    ...
    with tests.group_manager(PiglitCLTest, 'interop') as g:
    ...
    def add_program_test_dir(group, dirpath):
        for filename in os.listdir(dirpath):
            ...
            tests[grouptools.join(group, testname)] = CLProgramTest(
